...
const cssAnimate = "bounceInRight";
// zoomInDown
// slideInDown
// zoomIn
// flipInX
...
if(typeQuestion==8){
	...
	for(let i = 0; i < out.results.length; i++){
		...
		if(i == 5){
			htmlComponent += "<th class=\"text-normal\">";
			htmlComponent += " <div class=\"textbox textbox-primary other\">";
			htmlComponent += "  <div class=\"input-group\">";
			htmlComponent += "   <input type=\"text\" id=\"QAns11Other\" name=\"QAns11Other\" class=\"form-control\" placeholder=\"Other (please specify)\">";
			htmlComponent += "   <span class=\"input-group-addon\"><i class=\"fa fa-keyboard-o\"></i></span>";
			htmlComponent += "  </div>";
			htmlComponent += " </div>";
			htmlComponent += "</th>";
		}else{
		...
		for(let j = 0; j < out.results.length; j++){
			htmlComponent += "	<td data-th='"+out.results[j].location.city+"' class=\"text-capitalize\">";
			htmlComponent += "		<label class=\"checkbox-container\" for=cQAns"+i+"_"+j+" data-toggle=\"tooltip\" title='"+out.results[j].location.city+"'>";
			htmlComponent += "			<input id=cQAns"+i+"_"+j+" type=\"checkbox\" name=cQAns"+i+" value=\"1\" data-skip=\"0\" autocomplete=\"off\">";
			htmlComponent += "			<span class=\"checkmark\"></span>";
			htmlComponent += "		</label>";
			htmlComponent += "	</td>";
		}
